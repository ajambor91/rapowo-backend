...
// Returns the private 'App\Repository\TextsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TextsRepository.php';

return $this->privates['App\\Repository\\TextsRepository'] = new \App\Repository\TextsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
