...
return $this->services['App\\Controller\\BaseController'] = new \App\Controller\BaseController(($this->services['lexik_jwt_authentication.encoder'] ?? $this->load('getLexikJwtAuthentication_EncoderService.php')));
