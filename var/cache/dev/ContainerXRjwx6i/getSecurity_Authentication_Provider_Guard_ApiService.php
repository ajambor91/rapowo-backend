...
}, 1), ($this->privates['security.user.provider.concrete.app_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppProviderService.php')), 'api', new \Symfony\Component\Security\Core\User\UserChecker());
